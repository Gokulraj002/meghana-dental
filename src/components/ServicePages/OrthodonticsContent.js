...
const serviceData = {
  ...
  gallery: [
    ...
    { src: '/services/ortho-img-p2-2.jpg', caption: 'Protruded teeth with deep bite' },
    { src: '/services/ortho-img-p3-1.jpg', caption: 'Cross bite — upper and lower teeth misaligned laterally' },
